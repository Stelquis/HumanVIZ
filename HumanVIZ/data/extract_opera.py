...
BASE_DIR = "/workspace/HumanVIZ/data/dataPDF"
...
for FOLDER_CODE, FOLDER_NAME in FOLDERS:
    ...
    OUTPUT_DIR = os.path.join("/workspace/HumanVIZ/data/dataSet", FOLDER_CODE)
...
print(f"  输出根目录:  /workspace/HumanVIZ/data/dataSet/")
print(f"{'#'*60}")
