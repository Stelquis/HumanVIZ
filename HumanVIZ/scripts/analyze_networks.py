...
输出:
  /workspace/HumanVIZ/data/processed/p2_metrics.json        — 每本剧本的完整指标
  /workspace/HumanVIZ/data/processed/p2_type_comparison.json — 类型间比较结果
"""
...
INPUT_PATH = "/workspace/HumanVIZ/data/processed/p2_networks.json"
OUTPUT_METRICS = "/workspace/HumanVIZ/data/processed/p2_metrics.json"
OUTPUT_COMPARISON = "/workspace/HumanVIZ/data/processed/p2_type_comparison.json"
