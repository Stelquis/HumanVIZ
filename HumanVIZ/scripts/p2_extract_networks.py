"""
Task 2 Phase 1: 批量角色共现网络提取
从全部 1473 本剧本的 JSON 中提取场景级角色共现关系，构建网络并计算基础指标

输出: /workspace/HumanVIZ/data/p2_networks.json
"""
...
OUTPUT_PATH = "/workspace/HumanVIZ/data/p2_networks.json"
...
def main():
    print("=" * 60)
    print("Task 2 Phase 1: 批量角色共现网络提取")
    print("=" * 60)
