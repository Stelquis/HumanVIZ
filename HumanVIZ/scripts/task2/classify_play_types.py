...
OUTPUT_DIR = PROJECT_ROOT / "data" / "processed" / "task2" / "classification_results"
CHECKPOINT_FILE = PROJECT_ROOT / "data" / "processed" / "task2" / "db_exports" / "classify_checkpoint.json"
